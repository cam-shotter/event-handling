...
function two () {
  ...
  two.addEventListener('mouseenter', makeBlank)
...
function four () {
  ...
  four.addEventListener('click', makeRound)
}

// Changes the background color of event's target
function makeRound (evt) {
  evt.target.style['border-radius'] = '50px'
}
